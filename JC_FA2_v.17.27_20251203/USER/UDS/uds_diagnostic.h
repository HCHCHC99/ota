...
#include "common.h"
#include "stdint.h"
#include "uds_did_rid.h"      // DID/RID ����
#include "uds_dl_if.h"        // �������ؽӿ�

/******************************�궨��(����)***********************************/
/* UDS ��� CAN ID ���� (���޸�) */
#define UDS_PHYSICAL_REQUEST_ID     0x18DA03F1   /* ����Ѱַ���� ID (TBOX �� �Ƹ�) */
// #define UDS_PHYSICAL_RESPONSE_ID    0x18DAF103   /* ����Ѱַ��Ӧ ID (�Ƹ� �� TBOX) */
#define UDS_PHYSICAL_RESPONSE_ID    0x18DAF103   /* ����Ѱַ���� ID (TBOX �� �Ƹ�) */
#define UDS_FUNCTIONAL_REQUEST_ID   0x18DBFFF0   /* ����Ѱַ���� ID (�㲥) */
