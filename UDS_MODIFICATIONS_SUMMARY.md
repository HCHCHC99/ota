...
| ISOTP_DEFAULT_RESPONSE_ID | — | `#define ISOTP_DEFAULT_RESPONSE_ID 0x18DAF103` | 新增默认响应CAN ID |
| ISOTP_ENABLE_FILTER_RECORD | — | `#define ISOTP_ENABLE_FILTER_RECORD 1` | 启用CAN ID过滤记录 |
